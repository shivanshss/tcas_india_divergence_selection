...
for sample_name in "${!sample_info[@]}"; do
    ...
    "$bwa" mem -B 8 -t "$num_threads" "$reference_genome" "$sample_output_dir/forward-paired.fq" "$sample_output_dir/reverse-paired.fq" > "${sample_name}_aligned.sam"
    ...
    # Step 10: Call SNPs using GATK HaplotypeCaller
    ...
    # Step 11: Convert genotyped VCF to VCF format using GenotypeGVCFs
    ...
    # Step 13: Annotate SNPs using ANNOVAR
